...
import org.example.jmh_generated.SortByCategoryWithEquidistance_jmhType;
public final class SortByCategoryWithEquidistance_test_jmhTest {
    ...
    public BenchmarkTaskResult test_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            SortByCategoryWithEquidistance_jmhType l_sortbycategorywithequidistance0_0 = _jmh_tryInit_f_sortbycategorywithequidistance0_0(control);
            ...
            while (control.warmupShouldWait) {
                l_sortbycategorywithequidistance0_0.test();
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            test_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_sortbycategorywithequidistance0_0);
            ...
            if (control.isLastIteration()) {
                f_sortbycategorywithequidistance0_0 = null;
            }
    ...
    public static void test_thrpt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SortByCategoryWithEquidistance_jmhType l_sortbycategorywithequidistance0_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult test_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            test_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_sortbycategorywithequidistance0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult test_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            test_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_sortbycategorywithequidistance0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void test_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, SortByCategoryWithEquidistance_jmhType l_sortbycategorywithequidistance0_0) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult test_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            test_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_sortbycategorywithequidistance0_0);
            control.preTearDown();
    ...
    public static void test_ss_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, int batchSize, SortByCategoryWithEquidistance_jmhType l_sortbycategorywithequidistance0_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    SortByCategoryWithEquidistance_jmhType f_sortbycategorywithequidistance0_0;
    
    SortByCategoryWithEquidistance_jmhType _jmh_tryInit_f_sortbycategorywithequidistance0_0(InfraControl control) throws Throwable {
        if (control.isFailing) throw new FailureAssistException();
        SortByCategoryWithEquidistance_jmhType val = f_sortbycategorywithequidistance0_0;
        if (val == null) {
            val = new SortByCategoryWithEquidistance_jmhType();
            f_sortbycategorywithequidistance0_0 = val;
        }
        return val;
    }
